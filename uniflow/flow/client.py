...
from uniflow.flow.config import ExtractConfig, RaterConfig, TransformConfig, FlowDictConfig
from uniflow.flow.server import ExtractServer, RaterServer, TransformServer, FlowDictServer
...
class FlowDictClient:    
    """Expand & Reduce Client"""

    def __init__(self, config: FlowDictConfig) -> None:
        """Client constructor
        ...
        """
        self._config = config
        self._server = FlowDictServer(asdict(self._config))
